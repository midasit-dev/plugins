...
const SideViewDrawing = (translate:any, SideLength:any, FoundationWidth:any, PileTableData:any, TopLevel:any, GroundLevel:any) => {
  ...
  const YAmplifyRatio = (canvasSize*0.8)/(TableMaxPileLength+height*0.1)
