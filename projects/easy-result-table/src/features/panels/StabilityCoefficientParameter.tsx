...
import {
  ...
  StabilityCoefficientParameterProps,
  DEFAULT_SETTINGS_STABILITYCOEFFICIENTPARAMETER,
} from "../types/panels";

const StabilityCoefficientParameter: React.FC<
  StabilityCoefficientParameterProps
> = ({ value = DEFAULT_SETTINGS_STABILITYCOEFFICIENTPARAMETER, onChange }) => {
  const [loadCaseList, setLoadCaseList] = useState<string[]>([]);
  const [selectedLoadCase, setSelectedLoadCase] = useState("DL");
  ...
  const handleFactorChange =
    (
      field: keyof Omit<StabilityCoefficientParameterSettings, "combinations">
    ) =>
...
export default StabilityCoefficientParameter;
