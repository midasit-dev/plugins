...
const CompSeismicData_NZS1170_5_2004 = (props: any) => {
  ...
  const [return_period_factor, setReturn_period_factor] = useRecoilState(
    VarReturnPeriodFactor
  );
  const [hazard_factor, setHazard_factor] = useRecoilState(VarHazardFactor);
  const [design_ductility_factor, setDesign_ductility_factor] = useRecoilState(
    VarDesignDuctilityFactor
  );
...
const CompDistanceFromNearestMajorFault = () => {
  ...
  const [
    ...
    setDistance_from_nearest_major_fault,
  ] = useRecoilState(VarDistanceFromNearestMajorFault);
  ...
  return (
    <GuideBox width="100%" row horSpaceBetween>
      <GuideBox width="inherit" row horSpaceBetween verCenter height={30}>
        ...
        <TextFieldV2
          error={
            !valids.VarDistanceFromNearestMajorFault(
              distance_from_nearest_major_fault
            )
          }
          width={100}
...
const CompSubSoilClass = () => {
  const [site_sub_soil_class, setSite_sub_soil_class] =
    useRecoilState(VarSiteSubSoilClass);
        ...
        <GuideBox spacing={2}>
          <GuideBox spacing={1}>
            <GuideBox row spacing={0.7}>
              ...
              <Typography variant="body1" color="third">
                Refer to Section 3.1.3 of NZS 1170.5
              </Typography>
            </GuideBox>
          ...
          <GuideBox spacing={1}>
            <GuideBox row spacing={0.7}>
              ...
              <Typography variant="body1" color="third">
                Refer to Section 3.1.5 of NZS 1170.5
              </Typography>
            </GuideBox>
            <GuideBox row spacing={0.7}>
              <Typography variant="h1">- Hazard Factor :</Typography>
              <Typography variant="body1" color="third">
                Refer to Section 3.1.4 of NZS 1170.5
              </Typography>
            </GuideBox>
            <GuideBox row spacing={0.7}>
              <Typography variant="h1">
                - Distance From Nearest Major Fault :
              </Typography>
              <Typography variant="body1" color="third">
                Refer to Section 3.1.6 of NZS 1170.5
              </Typography>
            </GuideBox>
            <GuideBox row spacing={0.7}>
              <Typography variant="h1">- Design Ductility Factor :</Typography>
              <Typography variant="body1" color="third">
                Refer to Section 4.3 of NZS 1170.5
              </Typography>
            </GuideBox>
          </GuideBox>
        </GuideBox>
