...
const CompSeismicData_SBC301_CR_2018 = (props: any) => {
  ...
  const [importance_factor, setImportance_factor] =
    useRecoilState(VarImportanceFactor);
  const [response_modification_factor, setResponse_modification_factor] =
    useRecoilState(VarResponseModificationFactor);
  const [long_tran_period, setLong_tran_period] =
    useRecoilState(VarLongTranPeriod);
  const [spectralAccelerationSs, setSpectralAccelerationSs] = useRecoilState(
    VarSpectralAccelerationSs
  );
  const [spectralAccelerationS1, setSpectralAccelerationS1] = useRecoilState(
    VarSpectralAccelerationS1
  );
      ...
      <Panel variant="strock" width="100%" padding={1}>
        ...
        <GuideBox width="100%" spacing={2}>
          ...
          <CompTypographyAndTextFieldNumOnly
            ...
            state={spectralAccelerationSs}
            setState={setSpectralAccelerationSs}
            error={!valids.VarSpectralAccelerationSs(spectralAccelerationSs)}
          />
          <CompTypographyAndTextFieldNumOnly
            title="Spectral Acceleration(S1)"
            state={spectralAccelerationS1}
            setState={setSpectralAccelerationS1}
            error={!valids.VarSpectralAccelerationS1(spectralAccelerationS1)}
          />
          <CompTypographyAndTextFieldNumOnly
            title="Importance Factor(Ie)"
            state={importance_factor}
            setState={setImportance_factor}
            error={!valids.VarImportanceFactor(importance_factor)}
          />
          <CompTypographyAndTextFieldNumOnly
            title="Response Modification Factor(R)"
            state={response_modification_factor}
            setState={setResponse_modification_factor}
            error={
              !valids.VarResponseModificationFactor(
          ...
          <CompTypographyAndTextFieldNumOnly
            ...
            state={long_tran_period}
            setState={setLong_tran_period}
        ...
        <GuideBox spacing={2}>
          <GuideBox spacing={1}>
            <GuideBox row spacing={0.7}>
              ...
              <Typography variant="body1" color="third">
                Refer to Table 20-1 of SBC301-CR (2018)
              </Typography>
            </GuideBox>
          ...
          <GuideBox spacing={1}>
            <GuideBox row spacing={0.7}>
              ...
              <Typography variant="body1" color="third">
                Spectral Response Acceleration Parameter at short periods as
            ...
            <GuideBox row spacing={0.7}>
              ...
              <Typography variant="body1" color="third">
                Spectral Response Acceleration Parameter at a period of 1s as
                defined in Section 11.4.1
              </Typography>
            </GuideBox>
            <GuideBox row spacing={0.7}>
              ...
              <Typography variant="body1" color="third">
                Short-period site coefficient as defined in Section 11.4.3
              </Typography>
            </GuideBox>
            <GuideBox row spacing={0.7}>
              <Typography variant="h1">- Fv :</Typography>
              <Typography variant="body1" color="third">
                Long-period site coefficient as defined in Section 11.4.3
              </Typography>
            </GuideBox>
            <GuideBox row spacing={0.7}>
              <Typography variant="h1">- Ie :</Typography>
              <Typography variant="body1" color="third">
                The Importance Factor as prescibed in Section 11.5.1
              </Typography>
            </GuideBox>
            <GuideBox row spacing={0.7}>
              <Typography variant="h1">- R :</Typography>
              <Typography variant="body1" color="third">
                The Response Modification Factor as given in Table 12-1
              </Typography>
            </GuideBox>
            <GuideBox row spacing={0.7}>
