...
export function checkPyScriptReady(callback: any) {
  console.log("check py script ready!");
...
export function dbGetTaperedSection() {
  return checkPyScriptReady(() => {
    const py_db_get_tapered_section_func =
      pyscript.interpreter.globals.get("py_db_read_tapered");
...
export function dbCreateTaperedSection(item: any) {
  return checkPyScriptReady(() => {
    const py_db_create_tapered_section_func = pyscript.interpreter.globals.get(
      "py_db_create_tapered"
    );
