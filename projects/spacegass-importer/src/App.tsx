        ...
        <m.GuideBox row verCenter spacing={2}>
          ...
          <m.Button
            onClick={async () => {
              ...
              //send api form-data using a fetch
              if (!content) {
                console.error("No content to send", content);
                return;
              }
              ...
              if (!res.ok) {
                enqueueSnackbar(
                  `Failed to convert the spacegass file to mct.`,
                  { variant: "error" }
                );
                return;
              }
              ...
              enqueueSnackbar(
                `Successfully converted the spacegass file to mct.`,
                { variant: "success" }
              );
