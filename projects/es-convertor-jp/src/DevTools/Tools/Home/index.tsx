...
const App = (props: any) => {
  ...
  return (
    <motion.div className="w-full h-auto" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <GuideBox show width="100%" row fill="#f5f6f7">
        ...
        <motion.div className="fixed top-[24px] right-[24px] w-auto h-auto z-1" animate={isOpen ? "open" : "closed"}>
          <motion.div
            className="hidden"
            variants={{
...
const SvgMinimize = () => (
  <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15 18L9 12L15 6" stroke="#353a3e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
);
