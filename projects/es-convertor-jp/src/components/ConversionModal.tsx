...
const ConversionModal: React.FC<ConversionModalProps> = ({
  ...
  const handleSendToCivilNX = useCallback(() => {
    // Add your Civil NX integration logic here
    // currentMctText contains the MCT data for the selected version
    console.log('Send to Civil NX clicked, version:', selectedTab === 0 ? '2025' : '2026');
    console.log('MCT Text:', currentMctText);
  }, [currentMctText, selectedTab]);
      ...
      <div onClick={(e) => e.stopPropagation()}>
        ...
        <GuideBox spacing={2} width="100%">
          ...
          <GuideBox row horSpaceBetween width="100%">
            ...
            <Button variant="contained" onClick={handleSendToCivilNX}>
