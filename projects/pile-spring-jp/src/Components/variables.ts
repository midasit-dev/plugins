...
import {
  ...
  CalculatePileCoordinates,
  ExtractNumbers,
  CalculatePileCenterCoordinates,
} from "../utils_pyscript";
/** App variables */
...
export const PileDataSelector = selector({
  ...
  get: ({ get }) => {
    ...
    let PileNums = 0;
    if (majorSpace == "" || majorSpace == "0") PileNums = 1;
    else PileNums = ExtractNumbers(majorSpace).length + 1;
...
/**Soil Spring Option */
export const ResistCal = atom({
  key: "ResistCal",
  default: true,
});

export const ResistVerMethod = atom({
  key: "ResistVerMethod",
  default: 1,
});

export const ResistVerUltimate = atom({
  key: "ResistVerUltimate",
  default: 0,
});

export const ResistLatAngle = atom({
  key: "ResistLatAngle",
  default: 0,
});

export const ResistLatLoad = atom({
  key: "ResistLatLoad",
  default: 0,
});
