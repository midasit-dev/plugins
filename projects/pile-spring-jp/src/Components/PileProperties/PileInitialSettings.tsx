...
function PileInitialSettings() {
  ...
  const [constructionMethod, setconstructionMethod] =
  ...
  const [concreteModulusTitle, setConcreteModulusTitle] = useRecoilState(
    ConcreteModulus_Title
  );
  ...
  return (
    <GuideBox>
      ...
      <TypoGraphyDropList
        ...
        onChange={(e: any) => {
          setconstructionMethod(e.target.value);
        }}
      />
      <TypoGraphyDropList
        padding={1}
        ...
        value={headCondition}
        onChange={(e: any) => {
          setheadCondition(e.target.value);
        }}
      />
      <TypoGraphyDropList
        padding={1}
        ...
        onChange={(e: any) => {
          setbottomCondition(e.target.value);
        }}
      />
    </GuideBox>
  );
