...
import { GuideBox, IconButton, Icon, DataGrid } from "@midasit-dev/moaui";
...
function SoilTable() {
  ...
  const columns: any = [
    {
      field: "LayerNo",
      headerName: translate("Soil_Table_No"),
      width: 50,
      editable: false,
      sortable: false,
    },
    {
      field: "LayerType",
      headerName: translate("Soil_Table_Type"),
      width: 100,
      editable: true,
      sortable: false,
      type: "singleSelect",
      valueOptions: [
        { value: "SoilType_Clay", label: translate("SoilType_Clay") },
        { value: "SoilType_Sand", label: translate("SoilType_Sand") },
        { value: "SoilType_Sandstone", label: translate("SoilType_Sandstone") },
      ],
    },
    {
      field: "LayerDepth",
      headerName: translate("Soil_Table_Level"),
      width: 100,
      editable: false,
      sortable: false,
    ...
    {
      field: "Depth",
      headerName: translate("Soil_Table_Depth"),
      width: 80,
      editable: true,
      sortable: false,
    },
    {
      field: "AvgNValue",
      headerName: translate("Soil_Table_AvgN"),
      width: 80,
      editable: true,
      sortable: false,
    },
    ...
    },
    {
      ...
      renderHeader: (params: any) => (
        <div style={{ lineHeight: "1", textAlign: "center" }}>
          {translate("Soil_Table_AE0_Normal")}
          <br />
          (kN/m²)
        </div>
      ),
    },
    {
      ...
      renderHeader: (params: any) => (
        <div style={{ lineHeight: "1", textAlign: "center" }}>
          {translate("Soil_Table_AE0_Seismic")}
          <br />
          (kN/m²)
        </div>
      ),
...

    {
      ...
      renderHeader: (params: any) => (
        <div style={{ lineHeight: "1", textAlign: "center" }}>
          E<span style={{ verticalAlign: "sub", fontSize: "smaller" }}>D</span>
          <br />
          (kN/m²)
        </div>
      ),
    ...
    (newRow: any) => {
      ...
      if (VsiEditable == true) {
        ...
        if (newRow.LayerType === "SoilType_Clay") {
          ...
          newRow.LayerType === "SoilType_Sand" ||
          newRow.LayerType === "SoilType_Sandstone"
        ) {
  ...
  return (
    <GuideBox>
      <GuideBox width={800} row horRight spacing={1}>
        <IconButton transparent onClick={handleAddClick}>
          <Icon iconName="Add" />
        </IconButton>
        <IconButton transparent onClick={handelRemoveClick}>
          <Icon iconName="Remove" />
        </IconButton>
      </GuideBox>
      <div style={{ height: 366, width: 800 }}>
        <DataGrid
