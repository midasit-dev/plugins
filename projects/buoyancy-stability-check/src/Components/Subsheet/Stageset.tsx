...
import {TextFieldV2, Panel, Typography, Button,GuideBox, DataGrid, Icon} from '@midasit-dev/moaui';
import {constructionDataState, topelementstate, bottomelementstate, exwallelementstate, inwallelementstate} from '../variables';
...
const Stageset = () => {
    ...
    const addRow = () => {
      console.log("bottomslabelement",bottomslabelement)
      console.log("exwallelement",exwallelement)
      console.log("topslabelement",topslabelement)
      console.log("inwallelement",inwallelement)
  ...
  return (
    <GuideBox  horLeft width={430} height={590} marginLeft={1}>
